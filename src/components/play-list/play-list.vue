<template>
  <transition name="list-fade">
    <div class="playlist" @click="hide" v-show="showFlag">
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            ...
            <span class="text" v-text="showModeText"></span>
        ...
        <scroll :refreshDelay="refreshDelay" class="list-content" :data="sequenceList" ref="listContent">
          <transition-group name="list" tag="ul">
            <li :key="item.id" class="item" ref="list" v-for="(item, index) in sequenceList" @click="selectItem(item, index)">
      ...
      <confirm title="是否清空播放列表" confirmBtntext="清空" @confirm="clearList" ref="confirm"></confirm>
    </div>
  </transition>
</template>
